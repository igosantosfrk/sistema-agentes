  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        postsale: {
          awaiting: "hsl(var(--postsale-awaiting))",
          onboarding: "hsl(var(--postsale-onboarding))",
          complete: "hsl(var(--postsale-complete))",
          followup: "hsl(var(--postsale-followup))",
          active: "hsl(var(--postsale-active))",
        },
        chart: {
          "1": "hsl(var(--chart-1))",
          "2": "hsl(var(--chart-2))",
